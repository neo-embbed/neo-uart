...
if exist "%BUNDLED_PY%" (
  echo [Neo UART] Using bundled Python runtime.
  set "PY_EXEC=%BUNDLED_PY%"
) else (
...
start "Neo UART Backend" cmd /k call "%PY_EXEC%" -m uvicorn app.main:app --host 127.0.0.1 --port 8000 --reload
